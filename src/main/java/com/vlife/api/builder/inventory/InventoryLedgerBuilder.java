...
@Singleton
public class InventoryLedgerBuilder extends ItemBuilder<InventoryLedger> {

    private final ProductDao productDao;
    private final WarehouseDao warehouseDao;
    private final ProductBuilder productBuilder;

    public InventoryLedgerBuilder(
    ...
    @Override
    public Map<String, Object> buildItemFull(InventoryLedger item) {
        ...
        Warehouse warehouse = item.getWarehouseId() != null
    ...
    @Override
    public List<Map<String, Object>> buildList(List<InventoryLedger> items) {
        ...
        Set<Integer> warehouseIds = items.stream()
                .map(InventoryLedger::getWarehouseId)
                .filter(Objects::nonNull)
                .collect(Collectors.toSet());
        ...
        for (InventoryLedger item : items) {
            Map<String, Object> x = new LinkedHashMap<>(autoBuild(item));
